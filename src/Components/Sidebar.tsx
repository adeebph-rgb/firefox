     ...
     <Drawer direction="right" open={isOpen} modal={false} shouldScaleBackground={false} onOpenChange={(open) => {
      ...
      {!isOpen && (
        <DrawerTrigger asChild>
          <Button
            ...
            className={`fixed bottom-4 right-2 z-50 transition-all duration-700 ${isHovered ? "w-28" : "w-9"} rounded-full border border-slate-500 shadow-sm hover:shadow-md hover:bg-slate-800 text-white`}
          >
          ...
          <div className="flex flex-row justify-between items-center border-">
            ...
            <div className="flex flex-wrap gap-2 mt-4 border-b border-zinc-500 pb-6">
              ...
              {uploadedImages.map((img, index) => (
                <div
                  ...
                  className={`w-32 h-24 cursor-pointer overflow-hidden border-2 transition-all hover:opacity-75 ${
            ...
            <div className='mt-4 p-4 flex flex-row items-center justify-between'>
              ...
              <DropdownMenuTrigger asChild>
                <Button  className="" variant="outline">{rowCount?` ${rowCount}`:'Rows'} <svg xmlns="http://www.w3.org/2000/svg" height="16px" viewBox="0 -960 960 960" width="16px" fill="currentColor">
      <path d="M480-360 280-560h400L480-360Z"/>
              ...
              <span className="text-base font-medium">Recommended Stories</span>
               ...
               <h5 className='absolute underline text-blue-500 bottom-5 flex items-center gap-1 cursor-pointer'>
  <svg  xmlns="http://www.w3.org/2000/svg" height="24px" viewBox="0 -960 960 960" width="24px"fill="currentColor" className="text-blue-500" >
